...
public class PdsConstants {
	...
	public final static String GP_URL_FOR_PATIENT_STATE = MODULE_ID + ".patient.state.url";
	
	public final static String GP_URL_FOR_PATIENT_STATE_CODE = MODULE_ID + ".patient.state.code.url";
